...
.report-header { background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); padding: 28px 32px; margin-bottom: 24px; }
.report-header h1 { font-size: 30px; font-weight: 600; letter-spacing: -0.035em; line-height: 1.02; margin-bottom: 6px; }
.report-header .subtitle { color: var(--text-dim); font-size: 15px; }
.header-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px; margin-top: 24px; }
...
.controls label { font-size: 11px; color: var(--text-dim); text-transform: uppercase; letter-spacing: .1em; font-weight: 500; margin-right: 4px; }
...
.stat-card .stat-label { font-size: 10px; text-transform: uppercase; letter-spacing: var(--tr-caps); color: var(--text-dim); font-weight: 500; }
.stat-card .stat-value { font-size: 22px; font-weight: 600; margin-top: 4px; letter-spacing: -0.015em; font-variant-numeric: tabular-nums; }
...
th { text-align: left; padding: 9px 16px; font-size: 10.5px; text-transform: uppercase; letter-spacing: .1em; color: var(--text-dim); font-weight: 500; border-bottom: 1px solid var(--border); background: var(--surface2); }
...
.roll-card { background: var(--surface2); border: 1px solid var(--border-soft); border-radius: 10px; padding: 16px; }
.roll-card-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px; }
.roll-card-header h4 { font-size: 13.5px; font-weight: 600; font-variant-numeric: tabular-nums; letter-spacing: -0.005em; }
...
.layout-toggle { display: flex; gap: 2px; background: var(--surface2); border-radius: 9999px; padding: 3px; border: 1px solid var(--border); }
.layout-toggle .btn { border: none; background: transparent; padding: 4px 12px; border-radius: 9999px; font-size: 12px; }
.layout-toggle .btn.active { background: var(--compass); color: var(--graphite); }
...
.day-summary-card h3 { font-size: 17px; font-weight: 500; letter-spacing: -0.015em; margin-bottom: 4px; }
...
.cumulative-bar { background: var(--text); color: var(--bg); border-radius: var(--radius); padding: 14px 20px; margin-top: 12px; display: flex; gap: 32px; font-size: 13px; }
...
function renderHeaderHTML(project) {
  ...
  return `<div class="report-header">
    ...
    <div class="header-grid">
      ...
      ${project.checksum_type ? `<div class="header-item"><label>Verification</label><span>${esc(project.checksum_type)}</span></div>` : ''}
    </div>
...
<div class="container">
  ...
  <div class="controls">
    ...
    <div class="layout-toggle" id="themeToggle">
      <button class="btn active" data-theme="">Paper</button>
      <button class="btn" data-theme="theme-light">Light</button>
      <button class="btn" data-theme="theme-film">Dark</button>
    </div>
