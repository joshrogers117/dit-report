...
const BRAND_SVGS = {
  ...
  blackmagic: svgUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 75" fill="white"><text x="0" y="60" font-family="Arial,sans-serif" font-size="54" font-weight="700" letter-spacing="-1">Blackmagic</text></svg>'),
  dji: svgUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 60" fill="white"><text x="0" y="48" font-family="Arial,sans-serif" font-size="52" font-weight="700">DJI</text></svg>'),
  nikon: svgUri('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 140 50" fill="white"><text x="0" y="40" font-family="Arial,sans-serif" font-size="44" font-weight="700">Nikon</text></svg>'),
