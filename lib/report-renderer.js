...
function addTap(el, sel, fn) { el.addEventListener("click", function(e){var t=e.target.closest(sel);if(t&&el.contains(t))fn(t,e);}); el.addEventListener("touchend", function(e){var t=e.target.closest(sel);if(t&&el.contains(t)){e.preventDefault();fn(t,e);}}, {passive:false}); }
addTap(document.getElementById("themeToggle"), "[data-theme]", function(btn) {
  document.body.className = btn.dataset.theme;
  document.querySelectorAll("#themeToggle .btn").forEach(function(b){b.classList.toggle("active", b === btn)});
});
addTap(document.getElementById("layoutToggle"), "[data-layout]", function(btn) {
  currentLayout = btn.dataset.layout;
  document.querySelectorAll("#layoutToggle .btn").forEach(function(b){b.classList.toggle("active", b === btn)});
  render();
});
addTap(document.querySelector(".day-tabs"), ".day-tab", function(tab) {
...
function render() {
  ...
  if(grid) addTap(grid, "[data-goto-day]", function(card) {
