...
export async function seedDemoProject(db, userId) {
  ...
  await db.batch([
    bench(day2, 'Master', 880.1, 672.3, '4TB', 'APFS', 'Glyph Atom PRO — Thunderbolt 3', 1),
    bench(day2, 'Backup', 877.9, 669.1, '4TB', 'APFS', 'Glyph Atom PRO — Thunderbolt 3', 2),
  ...
  await db.batch([
    bench(day3, 'Master', 880.5, 670.8, '4TB', 'APFS', 'Glyph Atom PRO — Thunderbolt 3', 1),
    bench(day3, 'Backup', 879.1, 669.4, '4TB', 'APFS', 'Glyph Atom PRO — Thunderbolt 3', 2),
