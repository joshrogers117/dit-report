...
.verify-check { color: var(--accent2); font-weight: 600; }
...
function renderHeaderHTML(project) {
  ...
  return `<div class="report-header">
    <div class="header-grid">
      ...
      ${project.checksum_type ? `<div class="header-item"><label>Verification</label><span><span class="verify-check">&#10003;</span> ${esc(project.checksum_type)}</span></div>` : ''}
    </div>
