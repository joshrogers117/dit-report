...
export async function seedDemoProject(db, userId) {
  ...
  await db.batch([
    bench(day1, 'Shuttle_01', 879.8, 671.0, '4TB', 'APFS', 'SanDisk Extreme 55AE', 1),
    bench(day1, 'Shuttle_02', 878.7, 668.8, '4TB', 'APFS', 'SanDisk Extreme 55AE', 2),
  ...
  await db.batch([
    bench(day2, 'Shuttle_01', 880.1, 672.3, '4TB', 'APFS', 'SanDisk Extreme 55AE', 1),
    bench(day2, 'Shuttle_02', 877.9, 669.1, '4TB', 'APFS', 'SanDisk Extreme 55AE', 2),
  ...
  await db.batch([
    bench(day3, 'Titan_01', 2668.9, 2669.2, '4TB', 'APFS', 'OWC Envoy Pro FX — Thunderbolt 3', 1),
    bench(day3, 'Titan_02', 2639.6, 2674.2, '4TB', 'APFS', 'OWC Envoy Pro FX — Thunderbolt 3', 2),
