...
function renderHeaderHTML(project) {
  ...
  if (!project.director && !project.producer && !project.dp && !project.first_ac && !dateRange && !project.dit_name) return '';
