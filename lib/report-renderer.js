...
.theme-toggle { background: none; border: 1px solid var(--border); color: var(--text-dim); width: 34px; height: 34px; border-radius: 9999px; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; transition: color .15s, border-color .15s; -webkit-tap-highlight-color: transparent; }
...
(function(){
  ...
  if (t !== 'theme-light' && t !== 'theme-film') t = matchMedia('(prefers-color-scheme: dark)').matches ? 'theme-film' : 'theme-light';
